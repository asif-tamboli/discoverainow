...
const ALLOWED_EVENTS = new Set([
  ...
  "hero_prompts","hero_tools","prompt_gallery_image","prompt_gallery_coding","prompt_gallery_writing","prompt_gallery_qa","tool_finder_result","prompt_builder_generate","prompt_builder_copy","use_case_open","workflow_generator_generate","workflow_generator_copy","prompt_evaluator_run","prompt_evaluator_copy","output_verifier_run","output_verifier_copy","utility_feedback","utility_feedback_detail","guardrail_prompt_copy","stack_builder_result","replacement_finder_result","cost_plan_save","role_stack_view","workspace_save","workspace_clear","prompt_compare_run","prompt_compare_copy","content_request_submit","prompt_lab_compare","prompt_lab_copy","recommendation_click","engaged_session","session_exit","output_verifier_correction_copy","benchmark_image_protocol_open","prompt_lab_to_benchmark","image_guide_to_benchmark","benchmark_to_prompt_lab","benchmark_to_image_guide","image_intent_to_prompt_lab"
]);
